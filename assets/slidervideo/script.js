    ...
    if (!$('html').hasClass('is-builder')) {
        $(document).on('add.cards', function(event) {
            ...
            $(event.target).outerFind('[data-bg-video-slide]').each(function() {
                ...
                var $preview = $('<div class="custom-background-video-preview"></div>').css({
                    display: 'none',
                ...
                var $overlay = $(this).find('.custom-overlay');
                ...
                if (playerName === 'youtube') {
                    ...
                    if (isDesktop && $.fn.YTPlayer && !$(this).find('.playerBox').length) {
                        $('.container-slide', this)
                            .before('<div class="custom-background-video"></div>').prev()
                            .YTPlayer({
                                videoURL: videoId,
                                containment: 'self',
                                showControls: false,
                        ...
                        $(this).find('.image_wrapper .custom-overlay').css('opacity', '0');
                    }
                } else {
